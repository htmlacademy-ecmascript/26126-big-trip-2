...
function createDestinationSelectorTemplate(destinationById) {
  return (
    destinationById.description && destinationById.description ?
...
function createNewPointFormTemplate(point, dataOffers, dataDestinations) {
  ...
  ${createOffersSelectorTemplate(pointTypeOffer)}
  ${createDestinationSelectorTemplate(destinationById)}
